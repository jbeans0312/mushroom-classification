...
tree.plot_tree(pruned_tree.fit(X_train, y_train), feature_names=x.columns,
               class_names=y.columns, rounded=True,
               filled = True)
...
y_pred_en = pruned_tree.predict(X_test)
print(y_pred_en)
print("Accuracy of model is: ", accuracy_score(y_test, y_pred_en))